...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["contacto-contacto-contacto-module"], {
  ...
  function srcAppContactoContactoContactoComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(ContactoComponent, [{
        ...
        value: function entregarQRCode(index) {
          ...
          switch (index) {
            ...
            case 4:
              this.dataApi.getAllBooks().subscribe(function (books) {
                _this.value = books[1].twitter;
              });
              break;

            case 5:
              this.dataApi.getAllBooks().subscribe(function (books) {
                _this.value = books[1].facebook;
              });
              break;

            case 6:
              this.dataApi.getAllBooks().subscribe(function (books) {
                _this.value = books[1].youtube;
              });
              break;

            case 7:
              this.dataApi.getAllBooks().subscribe(function (books) {
                _this.value = books[2].twitter;
              });
              break;

            case 8:
              this.dataApi.getAllBooks().subscribe(function (books) {
                _this.value = books[2].youtube;
              });
              break;

            case 9:
              this.dataApi.getAllBooks().subscribe(function (books) {
                _this.value = books[2].facebook;
              });
              break;
          }
          /*if(index === 1){
    ...
    ContactoComponent.ɵfac = function ContactoComponent_Factory(t) {
      return new (t || ContactoComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_data_api_service__WEBPACK_IMPORTED_MODULE_1__["DataApiService"]));
    };
    ...
    ContactoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ContactoComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_12_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_15_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_18_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_28_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_31_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_34_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_44_listener() {
            return ctx.entregarQRCode(4);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_47_listener() {
            return ctx.entregarQRCode(5);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactoComponent_Template_span_click_50_listener() {
            return ctx.entregarQRCode(6);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](54, " Escanea el codigo QR para ir a la p\xE1gina ");
      ...
      directives: [ngx_qrcode2__WEBPACK_IMPORTED_MODULE_2__["QrcodeComponent"]],
  ...
  function srcAppContactoContactoContactoModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ContactoModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], ngx_qrcode2__WEBPACK_IMPORTED_MODULE_3__["NgxQRCodeModule"], _contacto_routing_module__WEBPACK_IMPORTED_MODULE_4__["ContactoRoutingModule"]]]
    });
